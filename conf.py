...
_C.ADAPTER.TEST = CN()
_C.ADAPTER.TEST.LAMBDA = 0.005
_C.ADAPTER.TEST.WEIGHT_EXPONENT = 2.0
_C.ADAPTER.TEST.MU = 0.99
_C.ADAPTER.TEST.SUP_SLR_GAMMA = 1e-8
_C.ADAPTER.TEST.LOW_UTILITY_COUNT_PATIENCE = 40
